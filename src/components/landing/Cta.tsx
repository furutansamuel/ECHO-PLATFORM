  ...
  return (
    <section className="relative overflow-hidden py-14 lg:py-20">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute -bottom-20 -right-16 h-72 w-72 rounded-full bg-emerald-400/20 blur-3xl" />
      </div>

      <div className="container mx-auto px-4">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary to-emerald-700 shadow-2xl">
