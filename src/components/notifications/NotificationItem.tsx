...
const typeConfig: Record<NotificationType, { icon: React.ElementType; color: string; bg: string }> = {
  'report_submitted': { icon: Info, color: 'text-blue-500', bg: 'bg-blue-50' },
  'verification_started': { icon: Clock, color: 'text-amber-500', bg: 'bg-amber-50' },
  'verification_completed': { icon: ShieldCheck, color: 'text-emerald-500', bg: 'bg-emerald-50' },
