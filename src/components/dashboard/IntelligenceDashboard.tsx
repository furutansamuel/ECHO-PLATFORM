    ...
    return (
        <div className="space-y-6">
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="flex-1">
                                        ...
                                        <div className="h-1.5 w-full bg-muted rounded-full overflow-hidden">
                                            <div className="h-full bg-blue-500" style={{ width: `${aiAnalysis?.flood_risk || 0}%` }} />
                                        </div>
                                    </div>
                                    <div className="flex-1">
                                        <p className="text-[10px] font-black text-muted-foreground uppercase mb-1">Waste Acc.</p>
                                        <div className="h-1.5 w-full bg-muted rounded-full overflow-hidden">
                                            <div className="h-full bg-emerald-500" style={{ width: `${aiAnalysis?.waste_accumulation || 0}%` }} />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="p-4 rounded-2xl bg-orange-50 border border-orange-100 flex gap-4 items-center group cursor-pointer hover:shadow-md transition-all">
                    <div className="p-2 rounded-lg bg-orange-500 text-white"><ShieldAlert className="h-4 w-4" /></div>
                    <div>
                        <p className="text-[10px] font-black text-orange-700 uppercase">Regional Alert</p>
                        <p className="text-xs font-bold leading-tight">Elevated Heatwave Forecast</p>
                    </div>
                    <ChevronRight className="h-3 w-3 text-orange-300 ml-auto group-hover:translate-x-1 transition-transform" />
                </div>

                <div className="p-4 rounded-2xl bg-blue-50 border border-blue-100 flex gap-4 items-center group cursor-pointer hover:shadow-md transition-all">
                    <div className="p-2 rounded-lg bg-blue-500 text-white"><Activity className="h-4 w-4" /></div>
                    <div>
                        <p className="text-[10px] font-black text-blue-700 uppercase">Water Insight</p>
                        <p className="text-xs font-bold leading-tight">Improved Reservoir Levels</p>
                    </div>
                    <ChevronRight className="h-3 w-3 text-blue-300 ml-auto group-hover:translate-x-1 transition-transform" />
                </div>

                <div className="p-4 rounded-2xl bg-emerald-50 border border-emerald-100 flex gap-4 items-center group cursor-pointer hover:shadow-md transition-all">
                    <div className="p-2 rounded-lg bg-emerald-500 text-white"><TrendingUp className="h-4 w-4" /></div>
                    <div>
                        <p className="text-[10px] font-black text-emerald-700 uppercase">Growth Index</p>
                        <p className="text-xs font-bold leading-tight">+15% Local Reforestation</p>
                    </div>
                    <ChevronRight className="h-3 w-3 text-emerald-300 ml-auto group-hover:translate-x-1 transition-transform" />
                </div>
