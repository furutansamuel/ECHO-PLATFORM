...
const badges = [
  { name: 'Eco Starter', icon: Star, color: 'text-blue-500', bg: 'bg-blue-500/10' },
  { name: 'Hazard Hunter', icon: Zap, color: 'text-orange-500', bg: 'bg-orange-500/10' },
  ...
  return (
    <div className="bg-card border rounded-2xl shadow-sm p-6 h-full flex flex-col relative overflow-hidden group">
      ...
      <div className="flex items-center gap-5 mb-8 relative z-10">
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center border shadow-xl shadow-orange-500/20 shrink-0 transform rotate-3">
      ...
      <div className="mt-8 pt-6 border-t relative z-10">
        <Button className="w-full font-black uppercase tracking-widest text-[10px] h-11 gap-2 bg-gradient-to-r from-yellow-500 to-orange-500 border-none shadow-lg shadow-orange-500/20 hover:shadow-orange-500/40 hover:scale-[1.02] transition-all">
          View Achievements
