...
const ContributionStats = () => {
  ...
  const contributionStats = [
    ...
    { label: 'Reports Verified', value: stats.reportsVerified.toString(), icon: CheckCircle2, color: 'text-blue-500', bg: 'bg-blue-500/10' },
    { label: 'Cleanups Joined', value: '04', icon: Calendar, color: 'text-orange-500', bg: 'bg-orange-500/10' },
    { label: 'Volunteer Hours', value: '24h', icon: Clock, color: 'text-purple-500', bg: 'bg-purple-500/10' },
    { label: 'Points Earned', value: (stats.ecoPoints / 1000).toFixed(1) + 'k', icon: Award, color: 'text-yellow-500', bg: 'bg-yellow-500/10' },
