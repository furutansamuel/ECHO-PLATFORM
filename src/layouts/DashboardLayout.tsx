...
export function DashboardLayout() {
  ...
  <div className="flex min-h-screen w-full bg-background font-sans text-foreground selection:bg-primary/10 selection:text-primary">
    ...
    <aside
      className={cn(
        "hidden md:flex flex-col w-64 bg-white border-r border-gray-200 shadow-sm transition-all duration-300 ease-in-out z-30",
        collapsed && "w-[70px]"
      )}
    >
      {/* Logo */}
      <div className="flex items-center justify-between p-4 border-b border-gray-100">
        ...
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 hover:bg-primary/10 transition-colors"
        >
          {collapsed ? (
        ...
        >
          <div className="flex items-center gap-4">
            <Sheet>
              ...
              <SheetContent
  side="left"
  className="w-[85vw] max-w-sm p-0 bg-white"
>
  {/* Logo */}
  ...
  {/* Navigation */}
  <div className="max-h-[calc(100vh-80px)] overflow-y-auto p-4 bg-white">
