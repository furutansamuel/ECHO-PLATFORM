...
const AIIntelligencePage: React.FC = () => {
  ...
  // Safe priority color handler to avoid 'toLowerCase' on undefined values
    ...
    <div className="p-4 md:p-6 space-y-8 max-w-7xl mx-auto pb-20">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="font-bold">{aiAnalysis?.flood_risk ?? 0}%</span>
            </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="font-bold">{aiAnalysis?.waste_accumulation ?? 0}%</span>
            </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="font-bold">{aiAnalysis?.pollution_level ?? 0}%</span>
            </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="font-bold">{aiAnalysis?.water_quality ?? 0}%</span>
            </div>
      ...
      <Card className="premium-shadow border-primary/5 hover:border-primary/20 transition-all group">
        ...
        <CardContent className="pt-2">
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-3xl font-black">{aiAnalysis?.waste_accumulation ?? 0}%</span>
        ...
        <CardContent className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-xl border p-4">
              <p className="text-xs text-muted-foreground">Reports Analysed</p>
              <h2 className="text-2xl font-black">{intelligenceSummary?.total_reports ?? 0}</h2>
            </div>

            <div className="rounded-xl border p-4">
              <p className="text-xs text-muted-foreground">Last AI Update</p>
              ...
              >
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline" className="text-[9px] uppercase border-current">
                      {rec.priority || 'Normal'}
                    </Badge>
                  </div>
      ...
      <Card className="shadow-xl border-primary/10 bg-gradient-to-br from-primary/5 via-background to-primary/10">
        <CardHeader>
          ...
          <CardDescription>Predicted environmental outlook for the next 7 days</CardDescription>
        </CardHeader>
