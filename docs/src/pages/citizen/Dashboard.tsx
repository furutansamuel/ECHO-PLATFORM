...
export default function Dashboard() {
  const { intelligenceSummary, aiAnalysis, hazardReports, articles, loading, error } = useIntelligenceData();
  ...
  return (
    <div className="space-y-5">
      ...
      {error ? (
        ...
        <>
          {/* 2. AI Environmental Brief */}
          <AIEnvironmentalBrief summary={intelligenceSummary} analysis={aiAnalysis} totalReports={totalReports} />
      ...
      {/* 4. Community Map */}
      <CommunityMapPreview reports={hazardReports} />

      {/* 5. Environmental Updates */}
      <EnvironmentalUpdatesCarousel reports={hazardReports} />

      {/* 6. Upcoming Cleanup */}
      <UpcomingCleanupFeatured />

      {/* 7. Learn Today */}
      <LearnTodayCard articles={articles} />
