...
export default function NotFound() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-160px)] overflow-hidden bg-background flex items-center justify-center px-4 py-20">
      ...
      <div className="absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-success/10 blur-3xl" />
      ...
      <div className="relative z-10 max-w-3xl w-full text-center">
        ...
        {/* 404 */}
        <h1 className="text-8xl md:text-9xl font-black bg-gradient-to-r from-primary to-success bg-clip-text text-transparent tracking-tight">
          404
        </h1>
