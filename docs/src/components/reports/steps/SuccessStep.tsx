    ...
    <div className="max-w-2xl mx-auto py-12 px-4 text-center">
      ...
      >
        <div className="relative">
          ...
          <div className="relative bg-card dark:bg-card p-6 rounded-full shadow-2xl border-4 border-primary/20">
          ...
          <motion.div
            ...
            className="absolute -bottom-4 -right-4 bg-highlight text-white px-4 py-2 rounded-full font-bold text-sm shadow-lg flex items-center gap-2"
          >
