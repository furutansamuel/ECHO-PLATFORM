...
const pieData = [
  { name: "Flood", value: 400, fill: "var(--chart-3)" },
  { name: "Waste", value: 300, fill: "var(--chart-2)" },
  { name: "Air Pollution", value: 300, fill: "var(--severity-high)" },
  { name: "Water Pollution", value: 200, fill: "var(--chart-3)" },
];
