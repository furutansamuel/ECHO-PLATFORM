...
// Status colour comes from the canonical map in lib/status-colors so the
// same status reads identically on every screen.
const statusVariant = (status: string) => statusTone(status);
